...
describe("测试 基于 xhr 封装的 createRetryRequestor", () => {
	let mockRequest: any;
	beforeEach(() => {
		vi.restoreAllMocks();
...
describe("测试 基于 xhr 封装的 createTimeoutRequestor", () => {
	beforeEach(() => {
		vi.useFakeTimers();
	});
	afterEach(() => {
...
describe("测试 基于 xhr 封装的 createParallelRequestor", () => {
	let mockRequest: any;
	beforeEach(() => {
		vi.restoreAllMocks();
		mockRequest = vi.spyOn(requestor, "_request");
...
describe("测试 基于 xhr 封装的 createSerialRequestor", () => {
	let mockRequest: any;
	beforeEach(() => {
		vi.restoreAllMocks();
		mockRequest = vi.spyOn(requestor, "_request");
...
describe("测试 基于 xhr 封装的 createCacheRequestor", () => {
	let mockRequest: any;
	const expectResult = {
		message: "请求 get 成功"
	};
...
describe("测试 基于 xhr 封装的 createIdempotentRequestor", () => {
	let mockRequest: any;
	const expectResult = {
		message: "请求 post 成功"
	};
...
describe("测试 基于 xhr 封装的 createAbortableRequestor", () => {
	it("测试能否正常取消", async () => {
